...
import { Sparkles, Brain, Users, Shield, Heart, ArrowRight, Instagram, ExternalLink } from 'lucide-react';
...
export default function SobreNosotrosPage() {
  return (
    <div className="flex flex-col gap-20 sm:gap-28 pb-20">
      ...
      {/* 5. NUESTRA COMUNIDAD DIGITAL EN INSTAGRAM */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="bg-gradient-to-br from-pink-500/10 via-purple-500/10 to-amber-500/10 rounded-3xl p-8 sm:p-12 border border-pink-500/30 shadow-ambient-1 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          <div className="flex flex-col md:flex-row items-center gap-5">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-amber-500 via-rose-500 to-purple-600 flex items-center justify-center text-white shadow-md flex-shrink-0">
            ...
            <div>
              ...
              <h3 className="text-2xl font-headline font-bold text-on-surface mt-0.5">
                Síguenos en Instagram @somos_diversamente
              </h3>
              <p className="text-sm font-body text-on-surface-variant max-w-xl mt-1">
                Conoce nuestro trabajo diario, testimonios de familias, cápsulas clínicas y recursos interactivos compartidos en nuestras historias y publicaciones.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <span>Unirme en Instagram</span>
            <ExternalLink className="w-3.5 h-3.5 opacity-80" />
          </a>
        </div>
      </section>

      {/* 6. CTA VOLUNTARIADO / DONAR */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
