...
import { Mail, ArrowRight, ShieldCheck, KeyRound, X, Send, Lock } from 'lucide-react';
    ...
    <div className="max-w-md w-full bg-surface rounded-3xl p-8 sm:p-10 border border-border shadow-ambient-2">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-xs font-body text-on-surface-variant mt-1.5">
          Ingresa tus credenciales para acceder a tu cuenta de Administrador o Suscriptor.
        </p>
      </div>
      ...
      {/* Register CTA */}
      <div className="mt-8 pt-6 border-t border-border text-center text-xs font-body text-on-surface-variant">
          ...
          <div className="relative w-full max-w-md bg-surface rounded-3xl p-6 sm:p-8 shadow-2xl border border-border">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-xs font-body text-on-surface-variant mt-1">
                Ingresa tu correo registrado y te enviaremos un enlace oficial de Supabase para cambiar tu clave.
              </p>
            </div>
